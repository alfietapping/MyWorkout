...
public class AdapterWorkoutSummary extends RecyclerView.Adapter<AdapterWorkoutSummary.AdapterViewHolder> {
    ...
    public AdapterWorkoutSummary(ArrayList<Exercise> exercises) {
    ...
    public static class AdapterViewHolder extends RecyclerView.ViewHolder {
        ...
        public AdapterViewHolder(@NonNull View itemView, final onClickListener listener) {
            super(itemView);

            expandedLayout = itemView.findViewById(R.id.workout_summary_constraint_layout);
            viewSetsLayout = itemView.findViewById(R.id.workout_summary_view_sets_layout);
            exerciseNameTV = itemView.findViewById(R.id.workout_summary_exercise_name_tv);
            setTV = itemView.findViewById(R.id.workout_summary_sets_holder);
            weightTV = itemView.findViewById(R.id.workout_summary_weight_holder);
            repsTV = itemView.findViewById(R.id.workout_summary_reps_holder);
            arrow = itemView.findViewById(R.id.card_view_workout_summary_arrow);
    ...
    public AdapterViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.card_view_workout_summary, viewGroup, false);
